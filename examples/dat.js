                    ...
                    if (void 0 !== a.className)
                        if (a.className === e) a.removeAttribute("class");
                            ...
                            var d = a.className.split(/ +/),
                                f = d.indexOf(e);
                            -1 != f &&
                                (d.splice(f, 1), (a.className = d.join(" ")));
                        }
            ...
            ? (this.__impliedStep =
                  0 == this.initialValue
                      ...
                      : Math.pow(
                            10,
                            Math.floor(
                                Math.log(Math.abs(this.initialValue)) /
                                    Math.LN10
                            )
                        ) / 10)
